...
import { FioriElementsVersion, Page } from './specification/common/page';
...
export interface GenerateSchemaV4 {
    [FioriElementsVersion.v4]: GenerateListReportV4 | GenerateObjectPageV4;
}
/**
...
export interface ExportParametersV4 {
    [FioriElementsVersion.v4]: ExportListReportV4 | ExportObjectPageV4 | ExportAppV4;
}
 ...
 */
export declare type ExportConfigParameters = ExportParametersV2 | ExportParametersV4;
/**
 * Types for v2 import
 */
...
export interface ImportParametersV4 {
    [FioriElementsVersion.v4]: ImportListReportV4 | ImportObjectPageV4;
}
