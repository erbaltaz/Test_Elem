...
export interface CommonTableSettings<COLS = GenericColumns> {
    ...
    /**
     * In the table toolbar, you can enable buttons to display or hide draft values. By default, these buttons are hidden. To enable them, set the showDraftToggle flag to true.
     */
