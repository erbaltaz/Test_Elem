...
__decorate([
    decorators_1.exportRule({
        flex: {
            ...
            controlType: () => types_1.ControlType.SmartTable,
...
], CommonTableSettings.prototype, "enableAutoBinding", void 0);
__decorate([
    decorators_1.exportRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
...
__decorate([
    decorators_1.exportRule({
        flex: {
            controlId: getSmartTableControlId,
            controlType: () => types_1.ControlType.Table,
            exportFunction: decoration_1.exportToFlexChange
        }
    })
...
], AnalyticalTable.prototype, "smartVariantManagement", void 0);
__decorate([
    decorators_1.exportRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
...
], AnalyticalTable.prototype, "showGoButtonOnFilterBar", void 0);
__decorate([
    decorators_1.exportRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
