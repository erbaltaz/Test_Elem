...
function generateObjectPageInterfaceV2(genericSchema, entitySet, annotations, manifest) {
    ...
    return objectPage_1.generateObjectPageSchemaV2(genericSchema, entitySet, entityTypes, manifest);
}
...
function generateListReportInterfaceV2(genericSchema, entitySet, annotations) {
    const entityTypes = utils_1.parseAndMergeAndConvert(annotations);
    return listReportObjectPage_1.generateListReportSchemaV2(genericSchema, entitySet, entityTypes);
}
