...
exports.getObjectPageCustomSectionPath = (pageName, sectionId, ...pathParts) => {
    ...
    if (sectionIdParts.length === 4) {
        // Four parts - last one is increament to avoid same path(but as I checked it is not order number)
        // We need merge 3 and 4 as one
